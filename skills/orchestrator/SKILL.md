...
- Known repos: `redeintegrativa-bot/*` (opencode-core, workstation, opencode-config, ai-operating-system, opencode-crypto-platform, cybersec-workstation, dotfiles, community-link-finder, maia-content-engine)
